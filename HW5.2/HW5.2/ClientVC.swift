...
class ClientVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor(red: 1, green: 0.86, blue: 0.34, alpha: 1)
        
        editButton(button: backButton, text: "Назад", textColor: .black, x: 10, y: 50, width: 100, height: 70)
        editButton(button: saveButton, text: "Сохранить", textColor: .black, x: 110, y: 500, width: 200, height: 70)
